...
OCAE CLI v1.1.4 is the versioned distribution layer for the OpenCode Agent
...
```bash
uv tool install ocae-cli --from git+https://github.com/Mueller-Systems-Lab/OpenCode-Agenten-Oekosystem.git@v1.1.4
```

The source ref is pinned to `v1.1.4`. The package does not clone the repository
