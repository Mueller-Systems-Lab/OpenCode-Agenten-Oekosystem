...
OCAE CLI v1.1.2 is the versioned distribution layer for the OpenCode Agent
...
The source ref is pinned to `v1.1.2`. The package does not clone the repository
