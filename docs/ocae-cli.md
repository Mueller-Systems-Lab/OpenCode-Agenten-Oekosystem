...
OCAE CLI v1.0.5 is the versioned distribution layer for the OpenCode Agent
...
The source ref is pinned to `v1.0.5`. The package does not clone the repository
