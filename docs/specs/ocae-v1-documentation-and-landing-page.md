...
Status: Completed — superseded by the stable v1.0.7 publication

## Goal

Reconcile active user-facing documentation with the released `ocae-cli` v1.0.7
...
- CLI installation: `uv tool install ...@v1.0.7`
- Hermes: optional and non-blocking

## Acceptance criteria

1. The first README screen removes the archive notice and presents the v1.0.7
...
|---|---|---|
| Truth | manifest, CLI version, agent directory | all resolve to v1.0.7 and 13 installable agents |
